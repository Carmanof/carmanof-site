...
const services = [
  ...
  { number: "02", title: "Пересвет панели", text: "Меняем цвет и яркость штатной подсветки, устраняем неравномерность и подбираем оттенок под интерьер автомобиля.", price: "от 5 000 ₽", href: "/services#lighting" },
  { number: "03", title: "Ремонт приборки", text: "Диагностируем неисправности, восстанавливаем электронику, индикацию и повреждённые элементы панели.", price: "от 3 500 ₽", href: "/services#repair" },
